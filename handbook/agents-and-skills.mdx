...
hub's own data, on two transports — *and* it catalogs the servers your project is wired to.

<Card title="Synclair's own MCP server" icon="plug" href="/agent-interface">
