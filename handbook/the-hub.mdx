---
title: "The hub, section by section"
...
Two more surfaces round out the hub — not big enough for their own page, but worth knowing:

- **GitHub** (`/synclair/github`) — recent commits and diffs. Git is the shared log; the
  hub just reads it.
- **⌘K search** — a command palette across everything: components, tokens, docs, pages.
- **Setup-mode badge** — the hub chrome shows whether this clone is *embedded* or
  *watcher* (see [Setup modes](/setup-modes)).
