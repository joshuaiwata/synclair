...
- **Raw color utilities** — Tailwind's literal color classes (`text-white`,
  `bg-blue-500`) that bypass the semantic palette exactly like a raw hex, but are
  invisible to a hex scan
