...
description: "The twenty-one checks that stand between an agent and \"done\" — what each one refuses to let through, and why the list is mostly about claims staying true."
---
